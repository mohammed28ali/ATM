...
int main()
{
    ...
    cout<<"      **************  PASSWORD FOR Mohammed    IS 6666   ************** \n";
    cout<<"      **************  PASSWORD FOR Fares       IS 7777   ************** \n";
    cout<<"      **************  PASSWORD FOR Amin        IS 8888   ************** \n\n\n";
    printstar('-',80);
    for(int i=1; i<=10; i++)
    {
                ...
                if (password==8888)
                {
                    for(int i=1; i<=10; i++)
                    {
                        ...
                        case 4:
                            ...
                            break;
                        default:
                            cout<<"\n That is an invalid option Plesse enter correct option:   \n";
                            continue;
                        }
                        break;
                    }
